...
def generate_notice_pdf(source_id: str) -> bytes:
    ...
    harm_score = harm_data.get("harm_score", harm_data.get("score", 0))
    ...
    stat_data = [
        [
            ...
            Paragraph("HARM SCORE", ParagraphStyle("sl", fontName="Helvetica-Bold", fontSize=8, textColor=WHITE, alignment=TA_CENTER)),
        ],
        [
            ...
            Paragraph(f"{round(harm_score):,}", ParagraphStyle("sv", fontName="Helvetica-Bold", fontSize=22, textColor=MID_BLUE, alignment=TA_CENTER)),
        ],
    ]
    ...
    story.append(Paragraph(
        ...
        "based on real-time sensor data, Gaussian plume dispersion modelling, and harm score analysis. "
